...
set project_name vpk120_dcmac_1x100g

# Set the project device:
set part xcvp1202-vsva2785-2MP-e-S
...
import_files -norecurse ../Hardware/seg_to_unseg/axis_seg_to_unseg_converter.v
update_ip_catalog
after 2000
...
#wait_on_run impl_1
#write_hw_platform -fixed -include_bit -force -file ../Hardware/prebuilt/${project_name}.xsa
