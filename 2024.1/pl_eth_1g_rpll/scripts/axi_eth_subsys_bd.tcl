...
proc create_hier_cell_rx_clk_led { parentCell nameHier } {
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins rx_clk_led]
...
proc create_hier_cell_mgt_tx_clk_led { parentCell nameHier } {
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_pins mgt_clk_led]
...
proc create_hier_cell_axi_clk_led { parentCell nameHier } {
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_pins xlslice_2/Dout] [get_bd_pins axi_lite_clk_led]
...
proc create_root_design { parentCell } {
  ...
  set lpddr4_sma_clk1_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 lpddr4_sma_clk1_0 ]
  set_property -dict [ list \
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_base/TX2_GT_IP_Interface bd_fb30_pcs_pma_0_0./axi_ethernet_0/gt_tx_interface.0 /gt_quad_base/RX2_GT_IP_Interface bd_fb30_pcs_pma_0_0./axi_ethernet_0/gt_rx_interface.0}\
\
    CONFIG.GT_TYPE {GTY} \
...
ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET K28.5 RX_COMMA_VALID_ONLY 0} \
    ...
    CONFIG.PROT_OUTCLK_VALUES {CH0_RXOUTCLK 390.625 CH0_TXOUTCLK 390.625 CH1_RXOUTCLK 390.625 CH1_TXOUTCLK 390.625 CH2_RXOUTCLK 62.5 CH2_TXOUTCLK 125 CH3_RXOUTCLK 390.625 CH3_TXOUTCLK 390.625} \
...
\
  ...
  connect_bd_intf_net -intf_net lpddr4_sma_clk1_0_1 [get_bd_intf_ports lpddr4_sma_clk1_0] [get_bd_intf_pins axi_noc_0/sys_clk1]
  ...
  # Create port connections
  connect_bd_net -net GT_WRAPPER_ch2_rxprogdivresetdone_0 [get_bd_pins gt_quad_base/ch2_rxprogdivresetdone] [get_bd_pins axi_ethernet_0/gtwiz_reset_rx_done_in]
  connect_bd_net -net GT_WRAPPER_ch2_txprogdivresetdone_0 [get_bd_pins gt_quad_base/ch2_txprogdivresetdone] [get_bd_pins axi_ethernet_0/gtwiz_reset_tx_done_in]
  ...
  connect_bd_net -net GT_WRAPPER_rxusrclk2 [get_bd_pins gt_bufg_gt_rxoutclk_ch2/usrclk] [get_bd_pins rx_clk_led/CLK] [get_bd_pins axi_ethernet_0/rxuserclk] [get_bd_pins axi_ethernet_0/rxuserclk2]
  ...
  connect_bd_net -net GT_WRAPPER_usrclk2 [get_bd_pins gt_bufg_gt_txoutclk_ch2/usrclk] [get_bd_pins mgt_tx_clk_led/CLK] [get_bd_pins axi_ethernet_0/userclk2]
  ...
  connect_bd_net -net gt_quad_base_ch0_txoutclk [get_bd_pins gt_quad_base/ch2_txoutclk] [get_bd_pins gt_bufg_gt_txoutclk_ch2/outclk] [get_bd_pins gt_bufg_gt_txoutclk_div2_ch2/outclk]
  connect_bd_net -net gt_quad_base_ch2_rxoutclk [get_bd_pins gt_quad_base/ch2_rxoutclk] [get_bd_pins gt_bufg_gt_rxoutclk_ch2/outclk]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_ports SFP0_TX_DISABLE]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins rx_clk_led/rx_clk_led] [get_bd_ports rx_clk_led]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins mgt_tx_clk_led/mgt_clk_led] [get_bd_ports mgt_clk_led]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins axi_clk_led/axi_lite_clk_led] [get_bd_ports axi_lite_clk_led]
