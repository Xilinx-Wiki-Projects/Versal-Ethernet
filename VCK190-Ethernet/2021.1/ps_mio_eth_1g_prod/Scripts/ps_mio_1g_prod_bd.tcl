...
################################################################
# This is a generated script based on design: ps_mio_1g_prod
#
...
# source ps_mio_1g_prod_script.tcl
...
set design_name ps_mio_1g_prod
...
DESIGN_MODE 1 IO_CONFIG_MODE Custom PCIE_APERTURES_DUAL_ENABLE 0\
PCIE_APERTURES_SINGLE_ENABLE 0 PMC_CRP_PL0_REF_CTRL_FREQMHZ 100\
...
{{ENABLE 1} {IO {PMC_MIO 38 .. 39}}} PS_TTC0_PERIPHERAL_ENABLE 1\
...
SMON_TEMP_AVERAGING_SAMPLES 8}\
  ...
  connect_bd_net -net noc_clk_gen_axi_clk_0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_0_smc/aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins noc_clk_gen/axi_clk_0]
  connect_bd_net -net noc_clk_gen_axi_rst_0_n [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_0_smc/aresetn] [get_bd_pins noc_clk_gen/axi_rst_0_n]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins noc_clk_gen/axi_clk_in_0] [get_bd_pins versal_cips_0/pl0_ref_clk]
  connect_bd_net -net versal_cips_0_pl0_resetn [get_bd_pins noc_clk_gen/axi_rst_in_0_n] [get_bd_pins versal_cips_0/pl0_resetn]
