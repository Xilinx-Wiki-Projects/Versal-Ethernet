...
set project_name vck190_mrmac_1x100g
...
#set impl_const ../Hardware/constraints/debug.xdc
add_files -fileset constrs_1 -norecurse {../Hardware/constraints/constraints.xdc ../Hardware/constraints/debug.xdc}
import_files -fileset constrs_1 {../Hardware/constraints/constraints.xdc ../Hardware/constraints/debug.xdc}
...
wait_on_run impl_1
write_hw_platform -fixed -include_bit -force -file ../Hardware/prebuilt/vck190-mrmac-1x100g.xsa
