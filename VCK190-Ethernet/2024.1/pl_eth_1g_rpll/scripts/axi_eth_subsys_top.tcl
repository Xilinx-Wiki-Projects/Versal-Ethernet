...
set proj_dir ../pl_axi1G_vck190/${project_name}_hw
...
wait_on_run impl_1
file mkdir ${proj_dir}/${project_name}/XSA
write_hw_platform -fixed -include_bit -force -file ${proj_dir}/${project_name}/XSA/${project_name}_wrapper.xsa
