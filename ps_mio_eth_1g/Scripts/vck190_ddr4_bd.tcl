...
################################################################
# This is a generated script based on design: vck190_ddr4
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PS_MIO_24_PULL {disable} \
   CONFIG.PS_MIO_24_SCHMITT {1} \
   CONFIG.PS_MIO_25_DIRECTION {inout} \
   CONFIG.PS_MIO_25_PULL {disable} \
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins versal_cips_0/pl0_ref_clk]
